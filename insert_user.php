...
// Validate the data
if (
    !isset($data->name) || !isset($data->email) || !isset($data->nim)
    || !isset($data->nohp) || !isset($data->alamat)
) {
...
$sql = "INSERT INTO users (name, email, nim, nohp, alamat) VALUES ('$name',
'$email', '$nim', '$nohp', '$alamat')";
